...
type Props = {
  ...
  showControls?: boolean;   // <-- เพิ่ม (ค่าเริ่มต้น: ซ่อน)
};
...
export default function DashBoardNavbar({
  ...
  user = {
    ...
    role: "Admin",
    avatarUrl:
      "https://marketplace.canva.com/m3zhI/MAEWdFm3zhI/1/tl/canva-human-face.-MAEWdFm3zhI.png",
  },
  rightExtra,
  showControls = false,     // <-- ซ่อนส่วนขวาเป็น default
}: Props) {
      ...
      <div className="flex flex-col items-start justify-between space-y-4 md:flex-row md:items-center">
        <div>
          ...
          <p className="text-gray-500">
            Welcome , {user.name} Explore outfits that bring out your confidence.
          </p>
        </div>
